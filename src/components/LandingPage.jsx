    ...
    return (
        <div style={{ background: palette.cream, color: palette.brown, fontFamily: "'Lora', Georgia, serif" }}>
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4">
                ...
                <Polaroid rotate="5deg"   label="Brooklyn, 1952"  tint="#A89070" className="top-[8%]  right-[6%]"   imageUrl="https://firebasestorage.googleapis.com/v0/b/echoes-prod-2afe6.firebasestorage.app/o/post_media%2FulTS5Y2Y6ab31Z5v0VNZibJnsRV2%2F1762103986842_Jena_1960er.jpg?alt=media&token=05bd1ea6-a90e-4219-926a-8d1042d4514b" />
                <Polaroid rotate="-3deg"  label="Grandma & Joe"   tint="#B8927A" className="bottom-[14%] right-[5%]" imageUrl="https://firebasestorage.googleapis.com/v0/b/echoes-prod-2afe6.firebasestorage.app/o/post_media%2FulTS5Y2Y6ab31Z5v0VNZibJnsRV2%2F1762104605109_Goethe_Wohnhaus_Weimar_1966.jpg?alt=media&token=f96fc128-856b-4c94-b72b-5e1a519b581f" />
